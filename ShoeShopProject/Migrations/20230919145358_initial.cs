        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFeature = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order_Address", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Order_Address_User",
                        column: x => x.User_Id,
                        principalTable: "User",
                        principalColumn: "User_Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cart_Item_Shoe_Id",
                table: "Cart_Item",
                column: "Shoe_Id");

            migrationBuilder.CreateIndex(
                name: "IX_Order_Address_User_Id",
                table: "Order_Address",
                column: "User_Id");
